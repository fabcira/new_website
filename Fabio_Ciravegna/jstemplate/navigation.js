...
document.write("        <li class='dropdown'>");
document.write("            <a href='#' class='dropdown-toggle' data-toggle='dropdown'>PhD Students <b class='caret'></b></a>");
document.write("            <ul class='dropdown-menu'>");
document.write("        <li><a href='PhD_Students.html'>Current and Past PhD Students</a></li>");
document.write("        <li><a href='OpenPositions.html'>Available PhD Projects</a></li>");
document.write("            </ul>");
document.write("        </li>");
