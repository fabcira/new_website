IMpreload('Contacts_files', 'shapeimage_3', '0');
IMpreload('Contacts_files', 'shapeimage_4', '0');
IMpreload('Contacts_files', 'shapeimage_5', '0');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupIEPNG("id3", "Contacts_files/transparent.gif");
    fixupIEPNG("shapeimage_3_link_0", "Contacts_files/transparent.gif");
    fixupIEPNG("shapeimage_3", "Contacts_files/transparent.gif");
    fixupIEPNG("shapeimage_4_link_0", "Contacts_files/transparent.gif");
    fixupIEPNG("shapeimage_4", "Contacts_files/transparent.gif");
    fixupIEPNG("shapeimage_5_link_0", "Contacts_files/transparent.gif");
    fixupIEPNG("shapeimage_5", "Contacts_files/transparent.gif");
    return true;
}
