IMpreload('SemWeb for KM_files', 'shapeimage_3', '0');
IMpreload('SemWeb for KM_files', 'shapeimage_4', '0');
IMpreload('SemWeb for KM_files', 'shapeimage_5', '0');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupIEPNG("id2", "SemWeb for KM_files/transparent.gif");
    fixupIEPNG("shapeimage_3_link_0", "SemWeb for KM_files/transparent.gif");
    fixupIEPNG("shapeimage_3", "SemWeb for KM_files/transparent.gif");
    fixupIEPNG("shapeimage_4_link_0", "SemWeb for KM_files/transparent.gif");
    fixupIEPNG("shapeimage_4", "SemWeb for KM_files/transparent.gif");
    fixupIEPNG("shapeimage_5_link_0", "SemWeb for KM_files/transparent.gif");
    fixupIEPNG("shapeimage_5", "SemWeb for KM_files/transparent.gif");
    return true;
}
